 ...
 */
 ...
 function loadForms(forms){
 	...
 	const approvedTable = document.getElementById("approvedData");
 	const awardedTable = document.getElementById("awardedData");
